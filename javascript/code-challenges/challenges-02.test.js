...
and returns a new array. The returned array should contain the result of raising 2 to the power of the original 
input element.
...
Write a function named forEachTwoToThe that produces the same output as your forLoopTwoToThe function
 from challenge 4, but uses forEach instead of a for loop.
------------------------------------------------------------------------------------------------ */

const forEachTwoToThe = (arr) => {
  let newarr= [];
  arr.forEach((arr) => newarr.push(Math.pow(2, arr)))
  return newarr;};
...
const mapTwoToThe = (arr) => {
  let newarr = arr.map(a => Math.pow(2, a));
  return newarr;

...
Write a function named addValues that, given an array of numbers as input, uses reduce
...
Write a function named addPurchases that, given an array of objects as input, uses reduce
 to find the total amount purchased. Each object contains the keys `item` and `purchasePrice`
like the example.
...
const addPurchases = (arr) => {
  ...
  let sum = arr.reduce(function (previousValue, currentValue) {
    return previousValue.purchasePrice + currentValue.purchasePrice;
...
Write a function named countNumberOfElements that, given an array as input, uses reduce to count the number 
...
Write a function named returnNames that, given the Star Wars data, below, uses reduce to return an 
...
const returnNames = (arr) => {
  let name = [];
  arr.reduce(function(p,c,index){
    if(index==1){
      name[index-1]=arr[index-1].name
    }
    name[index]=arr[index].name;
